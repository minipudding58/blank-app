...
st.markdown(f"""
    ...
    /* ✅ 검색 결과 카드: 회색 배경 및 중앙 정렬 (image_f64a5b.png) */
    .search-card {{
    ...
    /* 제목 텍스트 숨김 (image_f66125.png 레이아웃 유지) */
    .no-title-text {{
...
if q:
    try:
        ...
        if valid_books:
            # ✅ 가로 4열 배치 (image_f66125.png 완벽 복구)
            ...
            st.warning(f"'{q}' 검색 결과가 없습니다. 제목을 정확히 입력해주세요.")
