...
st.markdown(f"""
    ...
    div[data-testid="stHorizontalBlock"] {{
        ...
        flex-wrap: nowrap !important; /* 절대 다음 줄로 넘어가지 않음 */
        ...
        for i, item in enumerate(st.session_state.wishlist):
            with wish_cols[i % 4]:
                try:
                    ...
                    # 완료/삭제 강제 수평 밀착
                    wish_btn_cols = st.columns([1, 1])
                    with wish_btn_cols[0]:
